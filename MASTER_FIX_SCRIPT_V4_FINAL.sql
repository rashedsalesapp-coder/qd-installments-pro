-- =================================================================
-- MASTER DATABASE FIX SCRIPT (v4) - FINAL
-- INSTRUCTIONS: Please copy the entire content of this file and
-- run it in your Supabase project's SQL Editor. This is the
-- final corrected version.
-- =================================================================

-- Part 1: Fix Incompatible Data Types in AI Tables
-- This alters only the necessary columns to TEXT to match customers.id.
-- =================================================================
